                                ...
                                <div class="panel panel-default table-responsive">
                                    <table id="warehouseList" class="table table-bordered table-striped table-hover">
                                        ...
                                        <?php if(is_array($warehouseList)): foreach($warehouseList as $key=>$vo): ?><tr title="" data-id="<?php echo ($vo["id"]); ?>">
                                                ...
                                                <td>
                                                    <a class="label label-primary" title="查看库存" href="<?php echo U('Stock/stockList');?>?id=<?php echo ($vo["id"]); ?>">库存</a>
                                                    <a class="label label-warning btn-edit" title="编辑" href="<?php echo U('Stock/warehouseInfo');?>?id=<?php echo ($vo["id"]); ?>&way=edit" >编辑</a>
                                                    <a class="label label-danger btn-del" title="删除" href="<?php echo U('Stock/warehouseDel');?>" >删除</a>
                                                </td>
                                            </tr><?php endforeach; endif; ?>
                                        <?php if(empty($warehouseList)): ?><tr><td class="text-center empty-info" colspan="9">
