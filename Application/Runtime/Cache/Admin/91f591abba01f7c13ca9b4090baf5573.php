...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
            <li class="text-muted">销售管理</li><li class="text-muted">销售单列表</li><li class="text-muted">销售详情</li>
        </ul>
        ...
        <div class="tab-content ct-tab-content">
            ...
            <div class="builder listbuilder-box panel-body">
                ...
                <div class="builder-container">
                    <form id="sell" action="" method="post" class="form-inline" >
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    <label class="label-left">编码：</label>
                                    <span class="form-control"><?php echo ($sell["no"]); ?></span>
                                </div>
                                <div class="form-group col-xs-6">
                                    <label class="label-left">时间：</label>
                                    <span class="form-control"><?php echo ($sell["update_time"]); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <span class="form-control"><?php echo ($sell["title"]); ?></span>
                                </div>
                                <div class="form-group col-xs-6">
                                    <label class="label-left">状态：</label>
                                    <span class="form-control">
                                        <?php switch($sell["status"]): case "1": ?>交易完成<?php break;?>
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    <label class="label-left">仓库：</label>
                                    <span class="form-control"><?php echo ($sell["warehouse_out"]["name"]); ?></span>
                                </div>
                                <div class="form-group col-xs-6">
                                    <label class="label-left">负责人：</label>
                                    <span class="form-control"><?php echo ($sell["partner"]["name"]); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <span class="form-control"><?php echo ($sell["customer"]); ?></span>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table id="detailList" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($sell["detailList"])): foreach($sell["detailList"] as $key=>$vo): ?><tr>
                                                <td><?php echo ($vo["goods"]["name"]); ?>·<?php echo ($vo["goods"]["norm"]); ?></td>
                                                <td><?php echo ($vo["num"]); ?></td>
                                                <td><?php echo ($vo["per_price"]); ?></td>
                                                <td><?php echo ($vo[num] * $vo[per_price]); ?></td>
                                            </tr><?php endforeach; endif; ?>
                                        <tr>
                                            <td>合计</td>
                                            <td><?php echo ($sell["count_num"]); ?></td>
                                            <td></td>
                                            <td><?php echo ($sell["count_price"]); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                ...
                <div class="form-inline">
                    <div class="row" >
                        <div class="col-xs-12">
                            <div class="form-group col-xs-6">
                                <label class="label-left">总价：</label>
                                <span class="form-control"><?php echo ($sell["total_price"]); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 clearfix">
                            <div class="form-group">
                                ...
                                <div class="col-sm-11 col-lg-9">
                                    <span class="form-control"><?php echo ($sell["note"]); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
