...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
                <li class="text-muted">仓储管理</li><li class="text-muted">库存清单</li>
        </ul>
                    ...
                    <div class="row">
                        ...
                        <!--<div class="col-xs-12 col-sm-9 button-list clearfix">
                            <div class="form-group">
                                <a title="新增" class="btn btn-primary" href="<?php echo U('Stock/stockInfo');?>">新增</a>&nbsp;
                                <a title="删除" target-form="ids" class="btn btn-danger ajax-post confirm" model="Link" href="<?php echo U('Stock/stockDel');?>">删除</a>&nbsp;
                            </div>
                        </div>-->
                        <!-- 搜索框 -->
                        ...
                        <div class="col-xs-12">
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table id="stockList" class="table table-bordered table-striped table-hover">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <?php if(is_array($stockList)): foreach($stockList as $key=>$vo): ?><tr title="" data-id="<?php echo ($vo["id"]); ?>">
                                                <td><input class="ids" type="checkbox" value="<?php echo ($vo["id"]); ?>" name="ids[]"></td>
                                                <td><?php echo ($vo["goods"]["name"]); ?></td>
                                                <td><?php echo ($vo["goods"]["norm"]); ?></td>
