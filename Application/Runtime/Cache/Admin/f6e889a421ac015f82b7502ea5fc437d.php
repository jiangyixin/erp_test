...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
            <li class="text-muted">供应商管理</li><li class="text-muted">供应商详情</li>
        </ul>
                            ...
                            <form action="" class="form-horizontal">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-8 col-lg-7">
                                        <span class="form-control"><?php echo ($supplier["name"]); ?></span>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="col-sm-2 col-lg-1 control-label">分组</label>
                                    <div class="col-sm-8 col-lg-7">
                                        <span class="form-control"><?php echo ($supplier["group"]["name"]); ?></span>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="col-sm-2 col-lg-1 control-label">电话</label>
                                    <div class="col-sm-8 col-lg-7">
                                        <span class="form-control"><?php echo ($supplier["tel"]); ?></span>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="col-sm-2 col-lg-1 control-label">地址</label>
                                    <div class="col-sm-8 col-lg-7">
                                        <span class="form-control"><?php echo ($supplier["address"]); ?></span>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="col-sm-2 col-lg-1 control-label">创建时间</label>
                                    <div class="col-sm-8 col-lg-7">
                                        <span class="form-control"><?php echo ($supplier["create_time"]); ?></span>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="col-sm-2 col-lg-1 control-label">更新时间</label>
                                    <div class="col-sm-8 col-lg-7">
                                        <span class="form-control"><?php echo ($supplier["update_time"]); ?></span>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label class="col-sm-2 col-lg-1 control-label">备注</label>
                                    <div class="col-sm-8 col-lg-7">
                                        <span class="form-control"><?php echo ($supplier["note"]); ?></span>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($supplier["linkman"])): foreach($supplier["linkman"] as $key=>$vo): ?><tr>
                        ...
                        <div class="col-xs-12 col-sm-9 button-list clearfix">
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-lg-offset-1 col-sm-10">
                                    <a href="<?php echo U('Supplier/supplierInfo');?>?id=<?php echo ($supplier["id"]); ?>&way=edit" type="button" class="btn btn-primary">编辑</a>
