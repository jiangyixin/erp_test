                                ...
                                <div class="panel panel-default table-responsive">
                                    <table id="sellList" class="table table-bordered table-striped table-hover">
                                        ...
                                        <?php if(is_array($sellList)): $i = 0; $__LIST__ = $sellList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr title="" data-id="<?php echo ($vo["id"]); ?>">
                                                ...
                                                <td><?php switch($vo["status"]): case "1": ?>交易完成<?php break;?>
                                                ...
                                                <td>
                                                    ...
                                                    <?php switch($vo["status"]): case "1": ?><label class="label label-default">编辑</label><?php break;?>
                                                        <?php default: ?>
                                                        <a title="编辑" class="label label-primary" href="<?php echo U('sellEdit');?>?id=<?php echo ($vo["id"]); ?>">编辑</a><?php endswitch;?>
                                                    <?php switch($vo["status"]): case "1": ?><label class="label label-default">销售完成</label><?php break;?>
                                                        <?php case "0": ?><a class="label label-primary" href="javascript:;" data-status="1">完成交易</a><?php break;?>
