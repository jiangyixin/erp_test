...
<script type="text/javascript">
    ...
    var tableMenuData = [
        [{
            ...
            func: function() {
                ...
                window.location = "<?php echo U('Goods/goodsGroupInfo');?>?id=" + id;
            }
        }, {
            text: "删除",
            func: function() {
                ...
                if (!result) return;
                var id = $(this).attr('data-id');
                $.post("<?php echo U('Goods/goodsGroupDel');?>", { id: id}, function(data) {
                    if (data.status) {
    ...
    $(window).ready(function(e) {
        ...
        $("#goodsGroupList tr").smartMenu(tableMenuData, {
            name: "table"
        });
