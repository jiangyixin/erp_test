...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
            <li class="text-muted">采购管理</li><li class="text-muted">商品分组</li>
        </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9 button-list clearfix">
                            <div class="form-group">
                                <a title="新增" class="btn btn-primary" href="<?php echo U('Goods/goodsGroupInfo');?>">新增</a>&nbsp;
                                <!--<a title="删除" target-form="ids" class="btn btn-danger ajax-post confirm" model="Link" href="<?php echo U('Goods/goodsGroupDel');?>">删除</a>&nbsp;-->
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12">
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table id="goodsGroupList" class="table table-bordered table-striped table-hover">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <?php if(is_array($goodsGroupList)): foreach($goodsGroupList as $key=>$vo): ?><tr data-id="<?php echo ($vo["id"]); ?>">
                                                <!--<td><input class="ids" type="checkbox" value="<?php echo ($vo["id"]); ?>" name="ids[]"></td>-->
                                                <td><?php echo ($vo["id"]); ?></td>
                                                <td><?php echo ($vo["name"]); ?></td>
                                                <td><?php echo ($vo["note"]); ?></td>
                                                <td class="operate">
                                                    <a class="label label-warning btn-edit" title="编辑" href="<?php echo U('Goods/goodsGroupInfo');?>?id=<?php echo ($vo["id"]); ?>" >编辑</a>
                                                    <a class="label label-danger btn-del" title="删除" href="<?php echo U('Goods/goodsGroupDel');?>" >删除</a>
                                                </td>
