                            ...
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table  id="supplierList" class="table table-bordered table-striped table-hover">
                                        <caption><?php echo ($supplier["name"]); ?>采购列表</caption>
                                        <thead>
                                        <tr>
                                            <th>订单编号</th>
                                        ...
                                        <tbody>
                                        <?php if(is_array($supplier["procurementList"])): foreach($supplier["procurementList"] as $key=>$vo): if(is_array($vo['detailList'])): foreach($vo['detailList'] as $key=>$v): ?><tr title="" data-id="">
                                                    <td><?php echo ($vo["no"]); ?></td>
                                                    <td>
                                                        <?php if(is_array($partnerList)): foreach($partnerList as $key=>$i): if(($i["id"]) == $vo["partner_id"]): echo ($i["name"]); endif; endforeach; endif; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php if(is_array($goodsList)): foreach($goodsList as $key=>$i): if(($i["id"]) == $v["goods_id"]): echo ($i["name"]); ?>·<?php echo ($i["norm"]); endif; endforeach; endif; ?>
                                                    </td>
                                                    <td><?php echo ($v["num"]); ?></td>
                                                    <td><?php echo ($v["per_price"]); ?></td>
                                                    <td><?php echo ($v["update_time"]); ?></td>
                                                </tr><?php endforeach; endif; endforeach; endif; ?>
                                        <?php if(empty($supplier["procurementList"])): ?><tr>
