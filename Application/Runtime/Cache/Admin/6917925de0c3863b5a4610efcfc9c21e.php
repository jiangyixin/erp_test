                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <td class="td-select">
                                        <select name="procurement.supplier_id" class="form-control">
                                            ...
                                            <?php if(is_array($supplierList)): foreach($supplierList as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </td>
                                </div>
                                <div class="form-group col-xs-6">
    ...
    <script type="text/javascript">
        $(window).ready(function (e) {
            ...
            $('#save').on('click', function() {
                ...
                broadin.ajaxPost("<?php echo U('Goods/procurement');?>", {procurement: procurement, detailList: detailList});
            });
