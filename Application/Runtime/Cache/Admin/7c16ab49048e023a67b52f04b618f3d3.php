                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="hidden" name="sell.id" value="<?php echo ($sell["id"]); ?>">
                                    <input type="text" name="sell.no" value="<?php echo ($sell["no"]); ?>" readonly class="form-control">
                                </div>
                                <div class="form-group col-xs-6">
                                    <label class="label-left">时间：</label>
                                    <input type="text" class="form-control dateTimePicker" readonly name="sell.update_time" value="<?php echo ($sell["update_time"]); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="sell.title" value="<?php echo ($sell["title"]); ?>">
                                </div>
                                <div class="form-group col-xs-6">
                                    <label class="label-left">状态：</label>
                                    <select name="sell.status" class="form-control">
                                        <option <?php if(($sell["status"]) == "-1"): ?>selected<?php endif; ?> value="-1">已取消</option>
                                        <option <?php if(($sell["status"]) == "0"): ?>selected<?php endif; ?> value="0">计划中</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <select class="form-control" name="sell.warehouse_id_out">
                                        ...
                                        <?php if(is_array($warehouseList)): foreach($warehouseList as $key=>$vo): switch($vo["id"]): case $sell["warehouse_id_out"]: ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option><?php break;?>
                                                <?php default: ?>
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <select class="form-control" name="sell.partner_id">
                                        <option value="">请选择：</option>
                                        <?php if(is_array($partnerList)): foreach($partnerList as $key=>$vo): switch($vo["id"]): case $sell["partner_id"]: ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option><?php break;?>
                                                <?php default: ?>
                                                <option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endswitch; endforeach; endif; ?>
                                    </select>
                                </div>
                        ...
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="text" class="form-control" name="sell.customer" value="<?php echo ($sell["customer"]); ?>">
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table id="sellList" class="table table-bordered table-striped table-hover table-input">
                                        ...
                                        <tbody>
                                        <?php if(is_array($sell["detailList"])): foreach($sell["detailList"] as $key=>$vo): ?><tr data-id="<?php echo ($vo["id"]); ?>">
                                                <td class="td-select">
                                                ...
                                                <td><input type="number" data-count="num" name="num" value="<?php echo ($vo["num"]); ?>"></td>
                                                <td><input type="number" data-count="per_price" name="per_price" value="<?php echo ($vo["per_price"]); ?>"></td>
                                                <td><input type="text" name="sub_total" readonly="" value="<?php echo ($vo[num] * $vo[per_price]); ?>"></td>
                                                <td><input type="text" name="total" readonly="" value="<?php echo ($vo["total"]); ?>">
                                                <td class="operate">
                                            ...
                                            <tr class="tr-default">
                                                <td>总计</td>
                                                <td class="countNum"><?php echo ($sell["count_num"]); ?></td><td></td>
                                                <td class="countTotal"><?php echo ($sell["count_price"]); ?></td><td></td><td></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="row" >
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="number" class="form-control" name="sell.total_price" value="<?php echo ($sell["total_price"]); ?>">
                                </div>
                        ...
                        <div class="col-xs-12 clearfix">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-11 col-lg-9">
                                    <textarea class="form-control" name="sell.note"  rows="3"><?php echo ($sell["note"]); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(window).ready(function (e) {
            ...
            myTable.on('click', '.del-row', function() {
                broadin.delTableRow(this, "<?php echo U('Goods/sellDetailDel');?>");
            });
            ...
            $('#save').on('click', function() {
                ...
                broadin.ajaxPost("<?php echo U('Sell/sellEdit');?>", {sell: sell, detailList: detailList});
            });
