...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
            <li class="text-muted">采购管理</li><li class="text-muted">编辑商品信息</li>
        </ul>
        ...
        <div class="tab-content ct-tab-content">
            ...
            <div class="builder listbuilder-box panel-body">
                ...
                <!-- 数据列表 -->
                <form action="<?php echo U('Goods/goodsEdit');?>" method="post" class="form form-horizontal">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-8 col-lg-7">
                                        <input type="text" class="form-control" required="required" name="name" value="<?php echo ($goods["name"]); ?>">
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-8 col-lg-7">
                                        <select name="goods_group_id" class="form-control">
                                            <option value="0">请选择：</option>
                                            <?php if(is_array($groupList)): foreach($groupList as $key=>$vo): switch($vo["id"]): case $goods["goods_group_id"]: ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option><?php break;?>
                                                    <?php default: ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-8 col-lg-7">
                                        <input type="text" class="form-control" name="note" value="<?php echo ($goods["note"]); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-sm-9 button-list clearfix">
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-lg-offset-1 col-sm-10">
                                        <button type="submit" target-form="form" class="btn btn-primary">保存</button>
