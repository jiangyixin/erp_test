                                ...
                                <div class="panel panel-default table-responsive">
                                    <table id="goodsList" class="table table-bordered table-striped table-hover">
                                        ...
                                        <?php if(is_array($goodsList)): foreach($goodsList as $key=>$vo): ?><tr data-id="<?php echo ($vo["id"]); ?>">
                                                ...
                                                <td><?php echo ($vo["group"]["name"]); ?></td>
                                                <td><?php echo ($vo["note"]); ?></td>
                                                <td>
                                                    <a class="label label-warning btn-edit" title="编辑" href="<?php echo U('Goods/goodsInfo');?>?id=<?php echo ($vo["id"]); ?>" >编辑</a>
    ...
    var tableMenuData = [
        [{
            ...
            func: function() {
                ...
                window.location = "<?php echo U('Goods/goodsInfo');?>?id=" + id;
            }
        }, {
            text: "删除",
            func: function() {
                ...
                if (!result) return;
                var id = $(this).attr('data-id');
                $.post("<?php echo U('Goods/goodsDel');?>", { id: id}, function(data) {
                    if (data.status) {
                        $.alertMessager(data.info, 'success');
                        window.setTimeout(function() {
                            window.location = data.url;
