...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
            <li class="text-muted">供应商管理</li><li class="text-muted">供应商分组</li>
        </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9 button-list clearfix">
                            <div class="form-group">
                                <a title="新增" class="btn btn-primary" href="<?php echo U('Supplier/groupInfo');?>">新增</a>&nbsp;
                                <a title="删除" target-form="ids" class="btn btn-danger ajax-post confirm" model="Link" href="<?php echo U('Supplier/groupDel');?>">删除</a>&nbsp;
                            </div>
                        </div>
                        <!-- 搜索框 -->
                        ...
                        <div class="col-xs-12">
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table id="supplierGroup" class="table table-bordered table-striped table-hover">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <?php if(is_array($supplierGroupList)): foreach($supplierGroupList as $key=>$vo): ?><tr data-id="<?php echo ($vo["id"]); ?>">
...
<script type="text/javascript">
    ...
    var tableMenuData = [
        [{
            ...
            func: function() {
                ...
                window.location = "<?php echo U('Supplier/groupInfo');?>?id=" + id;
            }
        }, {
            text: "删除",
            func: function() {
                ...
                if (!result) return;
                var id = $(this).attr('data-id');
                $.post("<?php echo U('Supplier/groupDel');?>", { id: id}, function(data) {
                    if (data.status) {
    ...
    $(window).ready(function(e) {
        ...
        $("#supplierGroup tr").smartMenu(tableMenuData, {
            name: "table"
        });
