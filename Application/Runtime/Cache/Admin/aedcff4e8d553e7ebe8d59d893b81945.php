                                ...
                                <div class="panel panel-default table-responsive">
                                    <table id="supplierGroup" class="table table-bordered table-striped table-hover">
                                        ...
                                        <?php if(is_array($supplierGroupList)): foreach($supplierGroupList as $key=>$vo): ?><tr data-id="<?php echo ($vo["id"]); ?>">
                                                ...
                                                <td>
                                                    <a class="label label-warning btn-edit" title="编辑" href="<?php echo U('Supplier/groupInfo');?>?id=<?php echo ($vo["id"]); ?>" >编辑</a>
                                                    <a class="label label-danger btn-del" title="删除" href="<?php echo U('Supplier/groupDel');?>" >删除</a>
                                                </td>
