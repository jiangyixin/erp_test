...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
                <li class="text-muted">日志管理</li><li class="text-muted">系统操作日志</li>
        </ul>
        <!-- 主体内容区域 -->
        <div class="tab-content ct-tab-content">
                            ...
                            <form class="form" method="get" action="">
                                <div class="form-group">
                                    <div class="input-group search-form">
                                        <input type="text" name="keyword" class="search-input form-control" value="" placeholder="请输入ID">
                            ...
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table id="logList" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php if(is_array($dbLogList["rows"])): foreach($dbLogList["rows"] as $key=>$vo): ?><tr>
                                                    <td><?php echo ($vo["id"]); ?></td>
                                                    <td><?php echo ($vo["who"]); ?></td>
                                                    <td><?php echo ($vo["table_name"]); ?></td>
                                                    <td>
                                                        <?php switch($vo["crud"]): case "c": ?>新增<?php break;?>
                                                            <?php case "u": ?>修改<?php break;?>
                                                            <?php case "d": ?>删除<?php break; endswitch;?>
                                                    </td>
                                                    <td><?php echo ($vo["filter"]); ?></td>
                                                    <td title='<?php echo ($vo["old_data"]); ?>'><?php echo ($vo["old_data"]); ?></td>
                                                    <td title='<?php echo ($vo["new_data"]); ?>'><?php echo ($vo["new_data"]); ?></td>
