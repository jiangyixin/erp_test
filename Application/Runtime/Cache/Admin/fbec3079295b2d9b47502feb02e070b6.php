                                ...
                                <div class="panel panel-default table-responsive">
                                    <table  id="supplierList" class="table table-bordered table-striped table-hover">
                                        ...
                                        <?php if(is_array($supplierList)): foreach($supplierList as $key=>$vo): ?><tr title="" data-id="<?php echo ($vo["id"]); ?>">
                                                ...
                                                <td><?php if(is_array($vo["linkman"])): foreach($vo["linkman"] as $key=>$v): echo ($v["name"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?></td>
                                                <td>
                                                    <a class="label label-primary" title="采购信息" href="<?php echo U('Supplier/supplierProcurement');?>?id=<?php echo ($vo["id"]); ?>">采购信息</a>
                                                    <a class="label label-primary" title="供应商详细信息" href="<?php echo U('Supplier/supplierInfo');?>?id=<?php echo ($vo["id"]); ?>&way=show">详情</a>
                                                    <a class="label label-warning btn-edit" title="编辑" href="<?php echo U('Supplier/supplierInfo');?>?id=<?php echo ($vo["id"]); ?>&way=edit" >编辑</a>
                                                    <a class="label label-danger btn-del" title="删除" href="<?php echo U('Supplier/supplierDel');?>" >删除</a>
                                                </td>
