...
<div class="clearfix full-container">
    ...
    <div id="main" class="col-xs-12 col-sm-10 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            <li><i class="fa fa-map-marker"></i></li>
            <li class="text-muted">采购管理</li><li class="text-muted">采购单列表</li><li class="text-muted">采购详情</li>
        </ul>
        ...
        <div class="tab-content ct-tab-content">
            ...
            <div class="builder listbuilder-box panel-body">
                ...
                <div class="builder-container">
                    <form id="procurement" action="" method="post" class="form-inline" >
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    <label class="label-left">编码：</label>
                                    <span class="form-control"><?php echo ($procurement["no"]); ?></span>
                                </div>
                                <div class="form-group col-xs-6">
                                    <label class="label-left">时间：</label>
                                    <span class="form-control"><?php echo ($procurement["update_time"]); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <span class="form-control"><?php echo ($procurement["title"]); ?></span>
                                </div>
                                <div class="form-group col-xs-6">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    ...
                                    <span class="form-control"><?php echo ($procurement["supplier"]["name"]); ?></span>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="builder-table">
                                <div class="panel panel-default table-responsive">
                                    <table id="detailList" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($procurement["detailList"])): foreach($procurement["detailList"] as $key=>$vo): ?><tr>
                                        ...
                                        <tr>
                                            <td>合计</td>
                                            <td><?php echo ($procurement["count_num"]); ?></td>
                                            <td></td>
                                            <td><?php echo ($procurement["count_price"]); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="row" >
                        <div class="col-xs-12">
                            <div class="form-group col-xs-6">
                                ...
                                <span class="form-control"><?php echo ($procurement["total_price"]); ?></span>
                            </div>
                            <div class="form-group col-xs-6">
                                <label class="label-left">负责人：</label>
                                <span class="form-control"><?php echo ($procurement["partner"]["name"]); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 clearfix">
                            <div class="form-group">
                                ...
                                <div class="col-sm-11 col-lg-9">
                                    <span class="form-control"><?php echo ($procurement["note"]); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
