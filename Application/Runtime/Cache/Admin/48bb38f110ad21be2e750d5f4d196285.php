    ...
    <script type="text/javascript">
        ...
        $(window).ready(function (e) {
            ...
            function getFormData() {
                ...
                stockLog.partner = $('[name="stockLog.partner"]').val();
            ...
            $('#save').on('click', function() {
                ...
                $.post("<?php echo U('Stock/purchase');?>", {stockLog: stockLog, detailList: detailList}, function(data) {
                    console.log(data);
                    if (!data.status) {
